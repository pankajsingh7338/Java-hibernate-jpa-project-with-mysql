(function (global, factory) {
  ...
  // $WebSocketProvider.$inject = ['$rootScope', '$q', '$timeout',
	// '$websocketBackend'];
  function $WebSocketProvider($rootScope, $q, $timeout, $websocketBackend) {
    ...
    function $WebSocket(url, protocols, options) {
      ...
      this.maxTimeout = options && options.maxTimeout || 5 * 60 * 1000; // 5
																		// minutes
    ...
    $WebSocket.prototype.reconnect = function reconnect() {
      ...
      $timeout(_angular2.default.bind(this, this._connect), 5000);
...
//      $timeout(_angular2.default.bind(this, this._connect), backoffDelay);
    ...
    $WebSocket.prototype._getInternalState = function _getInternalState() {
